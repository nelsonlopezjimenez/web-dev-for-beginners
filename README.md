...
Visit
[**Student Hub page**](https://docs.microsoft.com/learn/student-hub/?WT.mc_id=academic-77807-sagibbon)
[**Student Hub page**](https://docs.microsoft.com/learn/student-hub/?WT.mc_id=academic-77807-sagibbon)
where you will find beginner resources, Student packs and even ways to get a free certificate voucher. This is the page you want to bookmark and check from time to time as we switch out content monthly.
...
> **A note about quizzes**: All quizzes are contained
> [in this app](https://ashy-river-0debb7803.1.azurestaticapps.net/),
> [or this app](http://localhost:8080/),
> for 48 total quizzes of three questions each. They are linked from within the lessons but the quiz app can be run locally; follow the instruction in the `quiz-app` folder. They are gradually being localized.

### Steps

1. cd into `quiz-app`. If there is no node_modules folder make sure to extract them from the provided resource.
1. type
...
1. You should see a server starting at port 8080
...
You do not need to install docsify. Just cd into the web-dev-for-beginners folder and run the following command
